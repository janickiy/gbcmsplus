...
/**
 * Создаем ссылку на детальную стату по ТБ
 */
class TBLink extends CellLink
{
  ...
  protected function toStringInternal($count)
  {
    ...
    return Html::a($count, ['tb', 'statistic' => $urlParams], ['data-pjax' => 0]);
  }
  ...
  {
    return $this->row->getTb();
  }

  /**
   * @return array [ключ_осн_статы => ключ_статы_тб]
   */
