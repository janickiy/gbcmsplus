...
l.first().addClass("selected sel");void 0===l.data("li-height")&&l.data("li-height",l.outerHeight());var K=k.css("top");"auto"==k.css("left")&&k.css({right:0});"auto"==k.css("top")&&k.css({top:J});k.hide();p.length&&(g.first().text()!=e.text()&&f.addClass("changed"),f.data("jqfs-class",p.data("jqfs-class")),f.addClass(p.data("jqfs-class")));if(a.is(":disabled"))return f.addClass("disabled"),!1;H.click(function(){c("div.jq-selectbox").filter(".opened").length&&d.onSelectClosed.call(c("div.jq-selectbox").filter(".opened"));
a.focus();if(!F){var b=c(window),q=l.data("li-height"),e=f.offset().top,p=b.height()-J-(e-b.scrollTop()),h=a.data("visible-options");if(void 0===h||""===h)h=d.selectVisibleOptions;var n=5*q,m=q*h;0<h&&6>h&&(n=m);0===h&&(m="auto");var h=function(){k.height("auto").css({bottom:"auto",top:K}).removeClass('to__top');var a=function(){r.css("max-height",Math.floor((p-20-D)/q)*q)};a();r.css("max-height",m);"none"!=E&&r.css("max-height",E);p<k.outerHeight()+20&&a()},w=function(){k.height("auto").css({top:"auto",bottom:K}).addClass('to__top');var a=
