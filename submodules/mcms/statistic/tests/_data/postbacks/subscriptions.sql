...
INSERT INTO sources (id, hash, user_id, default_profit_type, url, status, source_type, name, category_id, stream_id, domain_id, created_at, is_notify_subscribe, postback_url)
VALUES
  (
