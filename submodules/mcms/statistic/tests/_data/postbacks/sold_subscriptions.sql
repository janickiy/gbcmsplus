...
INSERT INTO sold_subscriptions (hit_id, time, date, hour, currency_id, profit_rub, profit_eur, profit_usd, landing_id, source_id, operator_id, platform_id, landing_pay_type_id, provider_id, country_id, stream_id, user_id, is_visible_to_partner)
VALUES
  (1, 1531236243, '2018-07-10', 15, 3, 9, 4, 5, 2, 1, 1, 4, 0, 0, 0, 1, 1,
   1);