...
/**
 * Достаем инфу по продажам из таблицы sold_trafficback
 */
class SoldTb extends BaseQuery
{
  ...
  public function init()
  {
    ...
    $this->select([
        'sold_tb' => 'COUNT(st.hit_id)',
        'sold_tb_profit_rub' => 'SUM(reseller_profit_rub)',
        'sold_tb_profit_eur' => 'SUM(reseller_profit_eur)',
        'sold_tb_profit_usd' => 'SUM(reseller_profit_usd)',
  ...
  public function handleFilterByCurrency($currency)
  {
    ...
    $this->andWhere(['st.currency_id' => Currency::getId($currency)]);
  }
