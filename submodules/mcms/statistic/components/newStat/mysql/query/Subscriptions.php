...
class Subscriptions extends BaseQuery
{
  ...
  {
    return [
      'revshare_ons' => 'SUM(count_ons_revshare)',
      'revshare_rebills' => 'SUM(count_rebills_revshare)',
      ...
      'revshare_partner_profit_rub' => 'SUM(partner_revshare_profit_rub)',
      'revshare_partner_profit_usd' => 'SUM(partner_revshare_profit_usd)',
      'revshare_partner_profit_eur' => 'SUM(partner_revshare_profit_eur)',
      'revshare_rebills24' => 'SUM(count_rebills24_revshare)',
      'revshare_offs24' => 'SUM(count_offs24_revshare)',
      'revshare_offs' => 'SUM(count_offs_revshare)',

      'buyout_offs' => 'SUM(count_offs_sold)',
      'rejected_offs' => 'SUM(count_offs_rejected)',
      'to_buyout_ons' => 'SUM(count_ons_cpa)',
      'buyout_offs_24' => 'SUM(count_offs24_sold)',
      'buyout_rebills' => 'SUM(count_rebills_sold)',
      'buyout_rebills_24' => 'SUM(count_rebills24_sold)',
      'buyout_reseller_profit_rub' => 'SUM(res_sold_profit_rub)',
      'buyout_reseller_profit_usd' => 'SUM(res_sold_profit_usd)',
      'buyout_reseller_profit_eur' => 'SUM(res_sold_profit_eur)',
    ];
  }
  /**
   * @inheritdoc
