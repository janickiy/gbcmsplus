...
class Alive extends BaseQuery
{
  ...
  {
    return [
      'revshare_total_ons_without_offs' => 'SUM(total_ons_without_offs_revshare)',
      'to_buyout_total_ons_without_offs' => 'SUM(total_ons_without_offs_cpa)',
    ];
  }
  /**
   * @inheritdoc
