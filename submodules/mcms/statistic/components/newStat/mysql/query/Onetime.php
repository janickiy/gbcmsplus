...
class Onetime extends BaseQuery
{
  ...
  public function init()
  {
    ...
    $this->from(['st' => 'onetime_subscriptions']);
  }
  ...
  {
    return [
      'otp_ons' => 'COUNT(st.hit_id)',
      'otp_visible_ons' => 'COUNT(IF(st.is_visible_to_partner = 1, 1, NULL))',
      'otp_partner_profit_rub' => 'SUM(profit_rub)',
      'otp_partner_profit_usd' => 'SUM(profit_usd)',
      'otp_partner_profit_eur' => 'SUM(profit_eur)',
      'otp_reseller_profit_rub' => 'SUM(reseller_profit_rub)',
      'otp_reseller_profit_eur' => 'SUM(reseller_profit_eur)',
      'otp_reseller_profit_usd' => 'SUM(reseller_profit_usd)',
      'otp_reseller_corrected_profit_rub' => 'SUM(IF(st.is_visible_to_partner = 0, reseller_profit_rub, 0))',
      'otp_reseller_corrected_profit_eur' => 'SUM(IF(st.is_visible_to_partner = 0, reseller_profit_eur, 0))',
      'otp_reseller_corrected_profit_usd' => 'SUM(IF(st.is_visible_to_partner = 0, reseller_profit_usd, 0))',
    ];
  }
