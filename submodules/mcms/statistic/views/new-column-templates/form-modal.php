...
use mcms\statistic\assets\NewColumnsTemplateAsset;
use yii\bootstrap\Html as BHtml;
use yii\helpers\Html;

/** @var \mcms\statistic\models\ColumnsTemplate $model */

NewColumnsTemplateAsset::register($this);
...
<?php $form = AjaxActiveForm::begin([
  ...
  'action' => $model->isNewRecord ? ['/statistic/new-column-templates/create'] : ['/statistic/new-column-templates/update', 'id' => $model->id],
      ...
      <div class="col-md-12">
        <?php if (!$model->isNewRecord) { ?>
          <?= Html::a(
            ...
            ['/statistic/new-column-templates/delete', 'id' => $model->id],
            [
