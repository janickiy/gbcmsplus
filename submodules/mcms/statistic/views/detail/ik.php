...
/** @var \mcms\statistic\models\mysql\DetailStatisticIk $statisticModel */
...
<div id="page-content-wrapper">
  <div class="container-fluid xyz">
    ...
    $gridColumns = [
      ...
      [
        ...
        'value' => function ($model) use ($statisticModel) {
          ...
          return Html::a($value, ['ik', 'statistic' => $searchAttrs], ['data-pjax' => 0, 'target' => '_blank']);
        }
      ],
      [
        'attribute' => 'ip',
        ...
        'value' => function($model, $key, $index, $column) {
          return empty($model['ip']) ? null : Yii::$app->formatter->asIpFromLong($model['ip']);
        }
      ],
      [
        'attribute' => 'email',
    ...
    $fullExportMenu = $statModule->canExportDetailStatistic() ? ExportMenu::widget([
      ...
      'filename' => Yii::_t('main.detail-statistic-ik'),
      'exportConfig' => [
