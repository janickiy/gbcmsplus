 ...
 *
 * TRICKY ИЗ-ЗА ПРОБЛЕМЫ https://github.com/yiisoft/yii2/commit/36960da10150e71ce19c53074e7ccc1debbf1b75
 * НАМ ПРИШЛОСЬ ПОДТЯНУТЬ ЭТОТ JS ОТДЕЛЬНО, ЧТОБЫ НЕ ОБНОВЛЯТЬ ВЕСЬ ПРОЕКТ. КАК ТОЛЬКО ПРОЕКТ ОБНОВИТСЯ ДО 2.0.12 (а сейчас 2.0.11), то этот файл можно грохнуть. Также не забыть удалить переопределение этого ассета в конфиге admin/config/main.php.
 *
