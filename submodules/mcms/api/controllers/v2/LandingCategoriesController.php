...
/**
 * Class LandingCategoriesController
 * @package mcms\api\controllers
 */
class LandingCategoriesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $mapper = (new MapperBuilder(LandingCategoriesMapper::getName()))->build($queryParser);
