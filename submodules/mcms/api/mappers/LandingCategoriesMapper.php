...
use mcms\api\models\LandingCategory;
use yii\db\ActiveQuery;

/**
 * Class PartnersMapper
 */
class LandingCategoriesMapper extends BaseMapper
{
    /**
     * @inheritdoc
     */
    ...
    private function joinOperators(ActiveQuery $query)
    {
        ...
        $query->leftJoin([LandingsMapper::getName() => 'landings'], LandingsMapper::getName() . '.category_id = ' . static::getName() . '.id');
