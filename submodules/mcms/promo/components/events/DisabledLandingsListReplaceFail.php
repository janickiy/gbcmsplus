...
class DisabledLandingsListReplaceFail extends Event
{
  ...
  public function __construct($landings = null, Source $source = null, User $user = null)
  {
  ...
  {
    return Yii::_t('promo.events.disabled_landing_list_replace_failed');
  }
