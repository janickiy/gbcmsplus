  ...
  <div class="row">
    <div class="col-md-9">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-8">
          ...
          ?>
          <?= $form->field($model, 'operators_text')->textArea() ?>
    ...
    <div class="col-md-3">
      <div class="well">
        ...
        <hr>
        <?= $form->field($model, 'provider_id')->dropDownList($model->providers, ['prompt' => Yii::_t('app.common.not_selected')]) ?>
        ...
        ? $form->field(
          ...
          'status',
          ['options' => ['class' => 'form-group']]
        )->radioList($model->statuses, ['separator' => '&nbsp;&nbsp;&nbsp;&nbsp;'])->label(
        ...
        <?= $form->field($model, 'auto_rating')->checkbox() ?>
        <?= $form->field($model, 'rating')->dropDownList($model->ratings) ?>

        <hr>

        <?= $form->field($model, 'allow_sync_buyout_prices')->checkbox() ?>
        <?= $form->field($model, 'allow_sync_status')->checkbox() ?>
        <?= $form->field($model, 'allow_sync_access_type')->checkbox() ?>
