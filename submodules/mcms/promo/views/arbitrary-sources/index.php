...
$this->title = Yii::_t('arbitrary_sources.main');
...
<?php Pjax::begin(['id' => 'arbitrary-sources-pjax']); ?>
<?= AdminGridView::widget([
  'dataProvider' => $dataProvider,
  'filterModel' => $searchModel,
  'id' => 'arbitrarySourcesGrid',
  ...
  'columns' => [
    ...
    [
      'attribute' => 'operatorLandingLinks',
      'format' => 'raw',
    ...
    [
      ...
      'template' => '{update} {disable-modal} {enable}',
