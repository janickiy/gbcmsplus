 ...
 * @var \mcms\promo\models\BuyoutCondition $searchModel
 * @var int $settingBuyoutMinutes
 * @var int $settingBuyoutAfterFirstRebillOnly
 */
?>
...
<?= Modal::widget([
  ...
  'url' => Url::to(['/promo/buyout-conditions/create']),
]); ?>
<?php $this->endBlock() ?>

  <h4><?=Yii::_t('promo.buyout_conditions.global-settings')?>:</h4>

  <div><?=Yii::_t('promo.buyout_conditions.buyout-minutes', $settingBuyoutMinutes)?></div>
  <div><?=Yii::_t('promo.buyout_conditions.buyout-after-first-rebill-only', $settingBuyoutAfterFirstRebillOnly)?></div>
