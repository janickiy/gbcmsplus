...
<?php $this->beginBlockAccessVerifier('create-modal', ['PromoOfferCategoriesCreateModal']) ?>
<?= Modal::widget([
  'toggleButtonOptions' => [
    'tag' => 'a',
    'label' => \yii\bootstrap\Html::icon('plus') . ' ' . Yii::_t('promo.offer_categories.create'),
    ...
    <?= AdminGridView::widget([
      ...
      'columns' => [
        ...
        [
          ...
          'trueLabel' => Yii::_t("promo.offer_categories.status-active"),
          'falseLabel' => Yii::_t("promo.offer_categories.status-inactive"),
          'filterWidgetOptions' => [
            'pluginOptions' => [
              'allowClear' => true
            ],
