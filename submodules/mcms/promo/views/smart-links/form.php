...
$this->title = Yii::_t('promo.smart_links.update') . ' | ' . $model->name;
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="col-md-12">
        ...
        <?= $form->field($model, 'stream_id')->dropDownList(ArrayHelper::map(Stream::getStreamsByUserId($model->user_id), 'id', 'name')) ?>
