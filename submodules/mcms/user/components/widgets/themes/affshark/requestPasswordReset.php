...
<div class="modal-header">
  <button type="button" class="modal_close close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
  </button>
  <h3 class="modal-title text-center" id="myModalLabel"><?= Yii::_t('users.forms.request_password_title') ?></h3>
</div>
