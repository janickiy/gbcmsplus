...
class ECPMRubHandler extends BaseHandler
{
    /**
     * @inheritdoc
     */
    public function baseQuery(array $where = [])
    {
        return (new Query())
            ...
            ->leftJoin(
                ...
                'or',
                ['st.landing_id' => 0],
                ['default_currency_id' => self::CURRENCY_RUB],
