          ...
          fit: function () {
            ...
            if (display) {
              ...
              if (isHorizontal) {
                ...
                var columnsHeights = me.columnHeights = [];
                ...
                helpers.each(me.legendItems, function (legendItem, i) {
                  ...
                  if (currentColHeight + itemHeight > minSize.height) {
                    ...
                    columnsHeights.push(currentColHeight);
            ...
            if (opts.display) {
              ...
              var drawLegendBox = function (x, y, legendItem) {
                ...
                if (opts.labels && opts.labels.usePointStyle) {
                  ...
                  if (legendItem.hidden) {
                    var defaultFillStyle = ctx.fillStyle;
                    ctx.fillStyle = '#eee';
              ...
              helpers.each(me.legendItems, function (legendItem, i) {
                var textWidth = ctx.measureText(legendItem.text).width,
                  ...
                  x = cursor.x,
                  y = cursor.y;
                if (!!opts.align && opts.align === 'center' && !isHorizontal) {
                  y += (ctx.canvas.clientHeight - Math.max.apply(Math, me.columnHeights)) / 2;
                }
